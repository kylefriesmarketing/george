...
n_winterhalt:{ region:'winter', reg:'ache', title:'The Halt',
  ...
  choices:[
    ...
    { t:'Winter with Dean & Dawson. Perfect your German script by lamplight; let Inky rest his eyes while you rule lines.',
      kit:14, heat:1, crew:-1, fx:(S,P)=>{ logSee(P,'inky',2); S.nell=(S.nell||0)+1; }, go:'n_sandy' },
...
n_janrestart:{ region:'winter', reg:'lark', title:'Harry Wakes',
  ...
  choices:[
    { t:'Give it everything. Double shifts at the face and the trolley ropes till your palms read like maps.',
      pre:'flat out', feet:30, heat:2, crew:-1, fx:(S,P)=>{ if(S.heat>=8){S.feet=Math.max(0,S.feet-8);} dstreak(S,P); }, go:'n_collapse' },
    ...
    { t:'You’ve been asked for by name at Dean & Dawson — the spring surge of papers. Two hundred men need to be Norwegian by March.',
      pre:'the paper front', feet:8, kit:16, heat:1, fx:(S,P)=>{ logSee(P,'inky',2); }, go:'n_collapse' },
...
n_agency:{ region:'agency', reg:'dread', title:'Dean & Dawson, Working Nights',
  ...
  choices:[
    { t:'Sit for your photograph, learn your Norwegian name until it answers before your own, and drill the cover story against {FRIEND}’s cross-examination.',
      pre:'become the paper man', kit:18, heat:1, fx:(S,P)=>{ logSee(P,'inky',2); if(S.kit>=80) award(P,'deandawson'); }, go:'n_purge' },
    ...
    { t:'Run the tailor line instead: greatcoats down to civilian cut, buttons recast, RAF blue dyed with beetroot and boot polish.',
      kit:14, heat:1, fx:(S,P)=>{ if(S.kit>=80) award(P,'deandawson'); }, go:'n_purge' },
...
e_needle:{ kind:'home', art:'end_needle', title:'The Needle’s Eye',
...
e_longwalk:{ kind:'survive', art:'end_longwalk', title:'The Long Walk',
...
e_uniform:{ kind:'dark', art:'end_uniform', title:'The Other Uniform',
...
e_given_list:{ kind:'survive', art:'end_given_list', title:'The Given Place — the Other Weather',
...
e_garden:{ kind:'survive', art:'end_garden', title:'The Garden',
...
e_roadwest:{ kind:'survive', art:'end_roadwest', title:'The Road West',
...
e_roll:{ kind:'true', art:'end_roll', title:'Answering the Roll',
...
e_horse:{ kind:'home', art:'end_horse', title:'The Ones Who All Came Home',
...
e_relay:{ kind:'home', art:'end_relay', title:'The Relay',
...
e_keeper:{ kind:'true', art:'end_keeper', title:'The Light Does Not Go Out',
...
/* (e_pause — the M1 bookmark ending — was retired when M2 continued the road
   past The Garden into the trade year. Nothing has referenced it since; the
   save system covers "stop and come back". Removed in the M14 bug sweep.) */
...
const glossary = [
  ...
  ['Piccadilly & Leicester Square','Harry’s two halfway houses, set a third and two-thirds of the way along. A thing you can joke about is a thing you can live inside.'],
...
const companion = [
  ...
  { d:'The night of 24–25 March 1944', b:0, t:'The trap is frozen for ninety minutes. The tunnel breaks <b>some thirty feet short of the trees</b>, in open snow; a rope run to a blind behind the pines carries one tug for wait, two for go. An air-raid blackout kills the tunnel lights with men inside. At 4:55 the seventy-seventh man is seen, and a shot ends it. <b>Seventy-six out.</b> — <span class="cmp-x">The eighteenth man down that ladder is the traveller of Book Three.</span>' },
...
<p>On the night of 24–25 March 1944, in snow and blackout, the trap was found frozen, the exit broke short of the trees — clear of the wire but some thirty feet shy of cover — and a rope signal ran the night at walking pace. <b>Seventy-six men escaped</b> before a sentry found the hole at dawn as the seventy-seventh emerged. Seventy-three were recaptured.</p>
